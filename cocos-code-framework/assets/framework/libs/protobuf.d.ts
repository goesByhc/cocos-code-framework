...
export as namespace protobuf;
    ...
    /**
     * Provides ui type definitions.
     * Can also be used to provide additional google types or your own custom types.
     * @param name Short name as in `google$protobuf/protobuf/[name].proto` or full file name
    ...
    export namespace common {
        ...
        /**
         * Gets the root definition of the specified ui proto file.
         *
    ...
    /**
     * Loads one or multiple .proto or preprocessed .json files into a ui root namespace and calls the callback.
    ...
    /**
     * Loads one or multiple .proto or preprocessed .json files into a ui root namespace and returns a promise.
     * @param filename One or multiple files to load
     * @param [root] Root namespace, defaults to create a new one if omitted.
     * @returns Promise
     * @see {@link Root#load}
    ...
    /**
     * Synchronously loads one or multiple .proto or preprocessed .json files into a ui root namespace (node only).
     * @param filename One or multiple files to load
     * @param [root] Root namespace, defaults to create a new one if omitted.
